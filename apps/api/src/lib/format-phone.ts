 ...
 *
 * LID detection: callers must pass null for unresolved LID contacts
 * (phoneNumber column is null after Plan 2.1). If a non-null value is passed
 * that strips to fewer than 10 digits, it is treated as garbage.
 */
