...
/**
 * Retorna o conjunto de comandos SQL necessario para provisionar o schema baseline de um tenant.
 * Contém apenas CREATE TABLE IF NOT EXISTS statements (baseline idempotent).
 *
