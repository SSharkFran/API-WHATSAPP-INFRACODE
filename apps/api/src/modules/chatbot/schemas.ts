...
export const chatbotConfigSchema = z.object({
  ...
  responseDelayMs: z.number().int().min(0).max(60_000).default(10_000),
  ...
  servicesAndPrices: z.string().nullable().optional(),
...
export const upsertChatbotBodySchema = z.object({
  ...
  servicesAndPrices: z.string().max(8_000).nullable().optional(),
  aiFallbackProvider: chatbotFallbackProviderSchema.nullable().optional(),
